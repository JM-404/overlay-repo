        ...
        try:
            ...
            if tool_calls_list:
                for tool_call in tool_calls_list:
                    # Anthropic/Claude via OpenAI-compat gateways emits an
                    # empty string ("") for tools with no arguments, instead
                    # of the "{}" that OpenAI/DeepSeek send. json.loads("")
                    # raises JSONDecodeError — treat empty as an empty dict.
